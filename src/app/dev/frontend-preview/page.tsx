      ...
      <div className="mx-auto max-w-[90rem] px-5 py-10 sm:px-8 sm:py-14">
        <div className="max-w-3xl">
          ...
          <p className="type-body-large mt-4 text-text-secondary">
            Open any current product screen from Functions 01–16 without backend authentication or prerequisite setup. Product rules remain enforced when bypass mode is off.
          </p>
