...
function DemoPracticalAssessmentWorkspace({ courseId, courseTitle, previewState }: { courseId: string; courseTitle: string; previewState?: string }) {
  ...
  useEffect(() => {
    const timer = window.setTimeout(() => {
      ...
      const preview = previewState === "task" || previewState === "draft" || previewState === "evaluating" || previewState === "passed" || previewState === "needs-practice" ? previewState : undefined;
